...
define(['../entity/character/player/player', '../entity/entityfactory', 'data/mobdata', 'data/gatherdata', '../entity/character/mob/pet', 'lib/bison'], function(Player, EntityFactory, MobData, GatherData, Pet, BISON) {
