...
define(['text!../../shared/data/items.json',
        ...
        './item/items', 'entity/character/mob/mobs',
        '../data/mobdata', 'entity/character/npc/npcs',
        'entity/character/mob/pet', 'entity/character/player/player',
        'entity/objects/chest', './gather/gather', '../data/gatherdata'],
