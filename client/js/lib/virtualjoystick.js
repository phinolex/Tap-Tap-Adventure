...
{	
	...
	var x = Math.round((event.pageX - $("#canvas").offset().left) / this.getZoom());
	var y = Math.round((event.pageY - $("#canvas").offset().top) / this.getZoom());
	//log.info("x:"+x+",y:"+y);
...
VirtualJoystick.prototype._onTouchStart	= function(event)
{
	...
	// forward the action
	var x = Math.round((touch.pageX - $("#canvas").offset().left) / this.getZoom());
	var y = Math.round((touch.pageY - $("#canvas").offset().top) / this.getZoom());
	return this._onDown(x, y)
}
